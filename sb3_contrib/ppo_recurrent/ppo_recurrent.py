    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                episode_starts = th.tensor(self._last_episode_starts, dtype=torch.float32, device=self.device)
            ...
            for idx, done_ in enumerate(dones):
                if (
                    ...
                    with th.no_grad():
                        ...
                        episode_starts = th.tensor([False], dtype=torch.float32, device=self.device)
        ...
        with th.no_grad():
            ...
            episode_starts = th.tensor(dones, dtype=torch.float32, device=self.device)
